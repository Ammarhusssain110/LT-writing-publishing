...
<head>
    ...
    <title>Lt Writing | Publishing</title>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="navbar-buttons">
                    <a href="void:;" class="start-btn" data-bs-toggle="modal" data-bs-target="#exampleModal1">Let's Get
                        Started</a>
                    <a href="tel:<?php echo $locNumber;?>" class="call-btn" >call Now</a>
                </div>
            </nav>
        </div>
    </header>